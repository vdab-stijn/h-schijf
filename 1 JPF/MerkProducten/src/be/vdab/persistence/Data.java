...
public class Data {
    private static Product[] artikels = {
            new Perfume(0, "Dolce & Gabbana", "Light Blue", 100, 66.72),
            new Perfume(0, "BVLGARI", "BLV", 75, 61.52),
            new Deodorant(0, "DKNY", "Be Delicious Women", 100, 33.65,
                    Deodorant.DeoType.STICK),
            new Perfume(0, "Georgio Armani", "Code Donna", 50, 59.32),
//            new AfterShave(0, "Yves Saint Laurent", "Jazz", 50, 39.84,
//                    AfterShave.Soort.VAPO),
            new AfterShave(0, "Yves Saint Laurent", "Jazz", 50, 39.84,
                    AfterShave.AfterShaveType.VAPO),
            new Perfume(0, "Givency", "Absolutely Irresistible", 75, 75.42),
//            new AfterShave(0, "Yves Saint Laurent", "Jazz", 100, 57.76,
//                    AfterShave.Soort.VAPO),
            new AfterShave(0, "Yves Saint Laurent", "Jazz", 100, 57.76,
                    AfterShave.AfterShaveType.VAPO),
            new Perfume(0, "Ted Lapidus", "Pour Elle", 50, 44.48),
            new Perfume(0, "Georgio Armani", "Code Donna", 30, 39.84),
            new Perfume(0, "Georgio Armani", "Code Donna", 75, 76.00),
